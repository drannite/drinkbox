...
class IngredientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ingredient" do
    assert_difference('Ingredient.count') do
      post ingredients_url, params: { ingredient: { description: @ingredient.description, name: @ingredient.name, price: @ingredient.price } }
    end
  ...
  test "should update ingredient" do
    patch ingredient_url(@ingredient), params: { ingredient: { description: @ingredient.description, name: @ingredient.name, price: @ingredient.price } }
